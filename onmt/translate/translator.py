...
def build_translator(image_file, image_file_local, opt, report_score=True, logger=None, out_file=None):
    if out_file is None:
...
class Translator(object):
    ...
    def __init__(
        ...
        self.test_img_feats = image_file
        self.test_img_feats_local = image_file_local
        self.model = model
        self.fields = fields
    ...
    def _run_encoder(self, batch): 
        ...
        img_feats_local = torch.from_numpy(self.test_img_feats_local[idxs])
        ...
        enc_states, memory_bank, src_lengths, text_out, image_out = self.model.encoder(
            src, img_feats, img_feats_local, src_lengths)
