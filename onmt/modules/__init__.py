...
from onmt.modules.gumbel_multi_headed_attn import GumbelMultiHeadedAttention
...
__all__ = ["Elementwise", "context_gate_factory", "ContextGate", 'GumbelMultiHeadedAttention',
